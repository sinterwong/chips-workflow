...
import sys
sys.path.append("/open_explorer/ddk/samples/ai_toolchain/horizon_model_convert_sample/01_common/python/data/")
from transformer import *
from dataloader import *


def calibration_transformers(input_size):
    """
    step：
        1、pad resize to input_size
        2、NHWC to NCHW
        3、bgr to rgb
    """
    transformers = [
        PadResizeTransformer(target_size=input_size),
        HWC2CHWTransformer(),
