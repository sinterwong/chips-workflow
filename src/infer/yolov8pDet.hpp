...
#ifndef __INFERENCE_VISION_YOLOV8_POINTS_DETECTION_H_
#define __INFERENCE_VISION_YOLOV8_POINTS_DETECTION_H_
...
class Yolov8PDet : public Keypoints {
  ...
  //!
public:
  explicit Yolov8PDet(const AlgoConfig &_param, ModelInfo const &info)
