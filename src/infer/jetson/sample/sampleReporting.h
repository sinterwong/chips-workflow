...
//!
struct InferenceTrace {
  InferenceTrace(int s, float es, float ee, float is, float ie, float cs,
...
//!
void printEpilog(const std::vector<InferenceTime> &timings, float percentile,
                 int batchSize, std::ostream &osInfo, std::ostream &osWarning,
                 std::ostream &osVerbose);
